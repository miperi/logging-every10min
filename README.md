...
> Άνοιγμα αυτής της σελίδας στο [https://miperi.github.io/logging-every10min/](https://miperi.github.io/logging-every10min/)
...
* αναζήτηση για **https://github.com/miperi/logging-every10min** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/miperi/logging-every10min/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/miperi/logging-every10min** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/miperi/logging-every10min/raw/master/.github/makecode/blocks.png)
